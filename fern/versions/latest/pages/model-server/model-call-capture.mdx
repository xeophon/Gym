...
response payloads; those remain in `CaptureStore`. Unless a producer reports payload redaction,
[`ng_trajectory`](/reference/trajectory-capabilities) includes payload copies in the rollout record. Resume attempts use an
